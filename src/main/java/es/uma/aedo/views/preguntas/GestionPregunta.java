...
public class GestionPregunta {
     ...
     */
    public static VerticalLayout crearCamposRellenar(PreguntaService preguntaService) {
        ...
        bloqueComboBox.setItems(preguntaService.getAllBloques());

        camposLayout.setResponsiveSteps(
                new ResponsiveStep("0", 1),
                new ResponsiveStep("500px", 2));

        camposLayout.add(idField, enunciadoField, tipoComboBox);
